<template>
    <div class="content">
      ...
      <modal
        ...
        class="white-content"
      >
        <seller-create :fetch="fetchbuyerLists" :property-detail="propertyDetail"></seller-create>
      </modal>
    </div>
  </template>
    <script>
  ...
  import SellerCreate from "~/components/JobOrder/PropertyDetails/Seller/buyerListCreate.vue";
  import SellerUpdate from "~/components/JobOrder/PropertyDetails/Seller/buyerListUpdate.vue";
  ...
  export default {
    ...
    methods: {
      ...
      async fetchBuyerLists() {
        this.$store.dispatch("buyerList/fetchBuyerLists", this.propertyDetail.id).then(() => {
