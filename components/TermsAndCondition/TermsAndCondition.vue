  ...
  <card class="card-register card-white">
    <div class="container">
      ...
      <p>
        ...
        of G.P.G Management Consulting and Research Center Corp's Website,
        located at https://landmaster.app.
      </p>
      ...
      <p>
        We employ the use of cookies. By accessing landmaster, you agreed to use
        cookies in agreement with the G.P.G Management Consulting and Research
        Center Corp's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, G.P.G Management Consulting and Research Center
        Corp and/or its licensors own the intellectual property rights for all
        material on landmaster. All intellectual property rights are reserved.
        You may access this from landmaster for your own personal use subjected
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. G.P.G
        Management Consulting and Research Center Corp does not filter, edit,
        publish or review Comments prior to their presence on the website.
        Comments do not reflect the views and opinions of G.P.G Management
        Consulting and Research Center Corp,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their
        views and opinions. To the extent permitted by applicable laws, G.P.G
        Management Consulting and Research Center Corp shall not be liable for
      ...
      <p>
        G.P.G Management Consulting and Research Center Corp reserves the right
      ...
      <p>
        You hereby grant G.P.G Management Consulting and Research Center Corp a
      ...
      <p>
        ...
        the hyperlink compensates the absence of G.P.G Management Consulting and
        Research Center Corp; and (d) the link is in the context of general
      ...
      <p>
        ...
        e-mail to G.P.G Management Consulting and Research Center Corp. Please
      ...
      <p>
        No use of G.P.G Management Consulting and Research Center Corp's logo or
      ...
      <h3><strong>Your Privacy pwet</strong></h3>

      <p>Please read <nuxt-link class="link footer-link" :to="'/privacy-policy'">Privacy Policy</nuxt-link> </p>
