...
import PaymentHistoryView from "@/components/Timesheet/PaymentHistory/Staff/StaffPaymentHistoryView";
...
export default {
  ...
  computed: {
     ...
     */
    ...mapGetters({
      paymentHistories: "staffPaymentHistory/paymentHistories",
      paymentHistory: "staffPaymentHistory/paymentHistory",
      pagination: "staffPaymentHistory/paymentHistoriesPagination",
      staff: "user/staff",
      user: "user/user",
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "amount_w_currency", label: "Amount", sortable: true },
  ...
  methods: {
    ...
    async fetchPaymentHistory(id) {
      await this.$store.dispatch("staffPaymentHistory/fetchPaymentHistory", id);
    },
    async fetchPaymentHistories() {
      this.isBusy = true;
      await this.$store
        .dispatch("staffPaymentHistory/fetchPaymentHistories", this.pagination)
        .then(() => {
          this.isBusy = false;
        });
    },
