    ...
    <div class="row mt-5">
      <div class="col-12">
        <card card-body-classes="table-full-width">
          <h4 slot="header" class="card-title">Account Balance</h4>
          <div>
            <b-container fluid>
              <!-- <b-row> -->
...
import AccountBalanceView from "@/components/Timesheet/AccountBalance/Staff/StaffAccountBalanceView";
...
export default {
  ...
  computed: {
     ...
     */
    ...mapGetters({
      accountBalances: "staffAccountBalance/accountBalances",
      accountBalance: "staffAccountBalance/accountBalance",
      pagination: "staffAccountBalance/accountBalancesPagination",
      staff: "user/staff",
      user: "user/user",
  ...
  methods: {
    ...
    async fetchAccountBalance(id) {
      await this.$store.dispatch("staffAccountBalance/fetchAccountBalance", id);
    },
    async fetchAccountBalances() {
      this.isBusy = true;
      await this.$store
        .dispatch("staffAccountBalance/fetchAccountBalances", this.pagination)
        .then(() => {
          this.isBusy = false;
        });
    },
